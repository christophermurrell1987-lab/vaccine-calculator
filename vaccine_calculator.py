...
INOVO_VACCINES = {
    ...
    "Nobilis Rismavac +CA126": {"price_per_1000": 16.92, "notes": "Marek's - £16.92/1000 doses"},
    "Nobilis Rismavac HIGH PFU": {"price_per_1000": 45.09, "notes": "Marek's High PFU - £45.09/1000 doses"},
    "Innovax ND-ILT": {"price_per_1000": 33.83, "notes": "Vector MD+ND+ILT - £67.66/2000 doses"},
    "Innovax ND-IBD": {"price_per_1000": 33.475, "notes": "Vector MD+ND+IBD - £66.95/2000 doses"},
    "Innovax ILT-IBD": {"price_per_1000": 35.195, "notes": "Vector MD+ILT+IBD - £70.39/2000 doses"},
...
DAY_OLD_SPRAY_VACCINES = {
    "-- Select --": {"price_per_1000": 0.00, "notes": ""},
    "IB 4/91": {"price_per_1000": 4.748, "notes": "IB Variant - £56.97/12x1000 doses"},
    "IB Ma5": {"price_per_1000": 2.665, "notes": "IB Massachusetts - £31.98/12x1000 doses"},
    ...
    "Paracox 5": {"price_per_1000": 146.01, "notes": "Coccidiosis - £146.01/1000 doses"},
}
...
VACCINE_PROTECTION = {
    ...
    "Innovax ILT-IBD": ["Marek's Disease", "Inf. Laryngotracheitis (ILT)", "Gumboro (IBD)"],
    ...
    "Paracox 5": ["Coccidiosis (5-Strain Standard)"],
}

# Vector vaccines list
VECTOR_VACCINES = ["Innovax ND-ILT", "Innovax ND-IBD", "Innovax ILT-IBD", "Vectormune ND"]
...
any_double_dose = any([do_1_double, do_2_double, do_3_double, do_4_double])
novatech_passes = 2 if (day_old_inj_selected and any_double_dose) else 1
novatech_machine_cost = (NOVATECH_INJECTION_COST * num_chicks * novatech_passes) if day_old_inj_selected else 0
...
DISEASE_CATEGORIES = {
    ...
    "Coccidiosis": ["Coccidiosis (5-Strain Core Protection)", "Coccidiosis (8-Strain Broad Spectrum)", "Coccidiosis (5-Strain Standard)"],
